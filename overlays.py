...
class Overlays:
	...
	@classmethod
	def display_point(cls, position, size, color):
		cls.add_line(position + hg.Vec3(-size, 0, 0), position + hg.Vec3(size, 0, 0), color, color)
		cls.add_line(position + hg.Vec3(0, -size, 0), position + hg.Vec3(0, size, 0), color, color)
		cls.add_line(position + hg.Vec3(0, 0, -size), position + hg.Vec3(0, 0, size), color, color)
