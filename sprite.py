...
class Sprite:
	...
	def __init__(self, w, h, texture_path=None, picture=None, texture=None):
		self.width = w
		self.height = h
		...
		if texture_path is not None:
			...
			self.texture = hg.CreateTextureFromPicture(picture, "sprite_bm", 0, hg.TF_RGBA8)
		elif texture is not None:
			self.texture = texture
		else:
			print("SPRITE ERROR - No texture !")
			return
